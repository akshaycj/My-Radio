      ...
      <div style={{width:'90%',margin:'auto'}}>
        <Card>
          ...
          <div>
            ...
            <h3 style={{textAlign:'center'}}>Send Bitcoin amount you want to double: (Min -<strong>BTC</strong> 0.001)</h3>
            <br />
            <div style={{textAlign:'center'}}>
              <Input placeholder="Enter your wallet address" className='input' onChange={this.onVal.bind(this)} />
              <br/>
              <Button type="primary" className='button' onClick={this.onSub.bind(this)}>Double it for me</Button>
            </div>
          </div>
